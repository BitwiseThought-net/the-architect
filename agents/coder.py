...
def get_agent(tools=None, model_name=None):
    ...
    return Agent(
        ...
        backstory="""You are a master of Python development and containerized architecture. You focus on writing modular, well-documented code that adheres to best practices. You are highly skilled at analyzing existing codebases to provide optimizations.""",
        llm=local_llm,
        tools=tools or [],
        memory=True,
        verbose=True
