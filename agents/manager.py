...
def get_agent(tools=None):
    ...
    return Agent(
        ...
        backstory="""You are a highly efficient operations leader. You oversee the sequential 
        handoffs between agents, ensuring that the Researcher provided enough data, 
        the Auditor approved the plan, and the Coder met the requirements.""",
        llm=local_llm,
