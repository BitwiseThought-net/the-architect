...
def get_agent(tools=None, model_name=None):
    ...
    return Agent(
        ...
        backstory="""You are a senior security researcher with an obsession for 'Zero Trust' architecture. You specialize in identifying OWASP top 10 risks and ensuring that any generated code is hardened against common exploits.""",
        llm=local_llm,
        tools=tools or [],
        memory=True,
        verbose=True
