...
def get_agent(tools=None, model_name=None):
    ...
    return Agent(
        ...
        backstory="""You are a meticulous researcher with expertise in technical RAG systems. You excel at finding hidden details in local PDFs and validating them against live web data.""",
        llm=local_llm,
