...
def get_agent(tools=None, model_name=None):
    ...
    return Agent(
        ...
        backstory="""You are a veteran systems designer. You focus on the big picture, ensuring that code follows SOLID principles and that the chosen tech stack aligns with the project's long-term scalability and maintenance goals.""",
        llm=local_llm,
