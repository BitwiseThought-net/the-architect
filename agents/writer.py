...
def get_agent(tools=None, model_name=None):
    ...
    return Agent(
        ...
        backstory="""You are a world-class technical writer. You specialize in translating complex code and architectural patterns into user-friendly documentation, including READMEs, API guides, and system manuals.""",
        llm=local_llm,
