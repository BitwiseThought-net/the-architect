...
def get_agent(tools=None, model_name=None):
    ...
    return Agent(
        ...
        backstory="""You are an expert at finding the story within the data. Whether it is a massive CSV or a folder full of logs, you provide statistical summaries and actionable insights to guide the team's decisions.""",
        llm=local_llm,
